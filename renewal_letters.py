...
with open(r'Y:\BrioStack\Script Uploads\Renewal Letters.csv') as samplefile:
...
for l, d in zip(col2, date):
        ...
        #select ticket
        element = WebDriverWait(driver, 30).until(
                EC.element_to_be_clickable((By.XPATH, "/html/body/div[2]/div/div[3]/div/div[3]/div[2]/div[2]/div/div/div[1]/div[2]/table/tbody/tr/td[text()='Renewal']")))
        element.click()
        ...
        element = WebDriverWait(driver, 30).until(
                EC.presence_of_element_located((By.XPATH, "//html/body/brio-office-root/brio-office-navigation/div/div[13]/brio-customers-page/div/brio-generate-document/form/div/div/section[1]/p-card/div/div[2]/div/div[1]/div/div/p-dropdown/div/div[4]/div/ul/li/span[text()='Renewal Letter']")))
        element.click()
        element = WebDriverWait(driver, 30).until(
